...
export interface ConnectionProvider {
    ...
    sendTransaction?(transaction: Transaction, options?: ProviderFeatureOptions): Promise<Transaction | void>;
    signTransaction(transaction: Transaction, options?: ProviderFeatureOptions): Promise<Transaction>;
    signTransactions(transactions: Transaction[], options?: ProviderFeatureOptions): Promise<Transaction[]>;
...
//# sourceMappingURL=connectionProvider.types.d.ts.map